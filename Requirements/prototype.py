...
# Save to CSV files
monthly_table.to_csv('monthly_payment_comparison.csv', index=False)
summary_table.to_csv('3year_cost_summary.csv', index=False)
trade_in_table.to_csv('trade_in_breakdown.csv', index=False)
incentives_table.to_csv('incentives_breakdown.csv', index=False)
cost_difference_table.to_csv('cost_difference_breakdown.csv', index=False)
loan_payoff_table.to_csv('loan_payoff_breakdown.csv', index=False)
impairment_table.to_csv('vehicle_impairment_impact.csv', index=False)
lease_interest_table.to_csv('lease_interest_calculation.csv', index=False)
negative_interest_table.to_csv('negative_interest_explanation.csv', index=False)
investment_table.to_csv('investment_opportunity_calculation.csv', index=False)
due_at_delivery_table.to_csv('due_at_delivery_breakdown.csv', index=False)

print(f"\n\nTables saved to CSV files:")
print("- monthly_payment_comparison.csv")
print("- 3year_cost_summary.csv")
print("- trade_in_breakdown.csv")
print("- incentives_breakdown.csv")
print("- cost_difference_breakdown.csv")
print("- loan_payoff_breakdown.csv")
print("- vehicle_impairment_impact.csv")
print("- lease_interest_calculation.csv")
print("- negative_interest_explanation.csv")
print("- investment_opportunity_calculation.csv")
print("- due_at_delivery_breakdown.csv")